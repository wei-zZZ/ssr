...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/wei-zZZ/ssr/master/ssr.sh && chmod +x ssr.sh && bash ssr.sh
```
...
#### 下载安装:
``` bash
wget -N --no-check-certificate https://raw.githubusercontent.com/wei-zZZ/ssr/master/socat.sh && chmod +x socat.sh && bash socat.sh
```
